...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!freelance && !household) {
      setLocalError("Please select at least one module to manage");
      return;
    }
          ...
          <div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-5">
                ...
                <div>
                  <Label>
                    What do you want to manage?<span className="text-error-500">*</span>
                  </Label>
                  <div className="space-y-3 mt-2">
                    <label className="flex items-center cursor-pointer">
                      ...
                      />
                      <span className="ml-2 text-gray-700 dark:text-gray-400">Freelance projects</span>
                    </label>
                    <label className="flex items-center cursor-pointer">
                      <Checkbox
                        checked={household}
                      ...
                      />
                      <span className="ml-2 text-gray-700 dark:text-gray-400">Home finances</span>
                    </label>
                  </div>
                  <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    You can switch modules anytime inside the app
                  </p>
                </div>
                {/* <!-- Checkbox --> */}
